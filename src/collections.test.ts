...
describe("Visual Overhaul Meta Fields", () => {
  ...
  it("Flexbox should have anti-examples", () => {
    expect(COLLECTIONS.Flexbox.antiExamples).toBeDefined();
    expect(COLLECTIONS.Flexbox.antiExamples!.length).toBeGreaterThan(0);
    
    COLLECTIONS.Flexbox.antiExamples!.forEach(ex => {
      expect(ex.badCode).toBeDefined();
      expect(ex.goodCode).toBeDefined();
