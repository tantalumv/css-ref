...
export const typography: CSSProperty[] = [
  {n:'font-size',c:'Typography',d:'Sets the font size — supports px, rem, em, %, and fluid functions like clamp().',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'font-size: 1rem | clamp(1rem, 0.5rem + 2vw, 2rem)',m:'font-size',
  ...
  {n:'font-family',c:'Typography',d:'Specifies the typeface or ordered font stack to use.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'font-family: "Inter", system-ui, sans-serif',m:'font-family',
  ...
  {n:'font-weight',c:'Typography',d:'Sets the weight (boldness) of the font, from 100 (thin) to 900 (black).',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'font-weight: normal | bold | 400 | 700',m:'font-weight',
  ...
  {n:'line-height',c:'Typography',d:'Sets the height of a line box, controlling vertical spacing between lines of text.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'line-height: normal | 1.5 | 1.6 | 24px',m:'line-height',
  ...
  {n:'letter-spacing',c:'Typography',d:'Sets horizontal spacing (tracking) between characters.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'letter-spacing: normal | 0.05em | -0.02em',m:'letter-spacing',
  ...
  {n:'text-wrap',c:'Typography',d:'Controls text wrapping — balance distributes evenly, pretty avoids orphans at paragraph ends.',s:{ch:1,ff:1,sf:1,ed:1},i:'b2024',x:'text-wrap: wrap | nowrap | balance | pretty | stable',m:'text-wrap',
  ...
  {n:'text-decoration',c:'Typography',d:'Adds decorative lines to text — underline, overline, line-through, with style and colour control.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'text-decoration: underline | overline dashed red | line-through',m:'text-decoration',
  ...
  {n:'clamp()',c:'Typography',d:'Math function that constrains a value between a min and max with a fluid preferred value.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'font-size: clamp(1rem, 0.5rem + 2vw, 1.5rem)',m:'clamp',
  ...
  {n:'font-optical-sizing',c:'Typography',d:'Allows font glyphs to be adjusted optically for different font sizes.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'font-optical-sizing: auto | none',m:'font-optical-sizing',
  ...
  {n:'text-align',c:'Typography',d:'Sets the horizontal alignment of inline content — left, right, center, justify, or match-parent.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'text-align: left | right | center | justify | start | end',m:'text-align',
  ...
  {n:'white-space',c:'Typography',d:'Controls how white space is handled and whether text wraps — nowrap, pre, pre-wrap, pre-line, break-spaces.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'white-space: normal | nowrap | pre | pre-wrap | pre-line',m:'white-space',
  ...
  {n:'text-overflow',c:'Typography',d:'Controls how overflowed text is signaled — ellipsis, clip, or custom string (Firefox).',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'text-overflow: clip | ellipsis | "…"',m:'text-overflow',
  ...
  {n:'text-shadow',c:'Typography',d:'Adds shadow effects to text — accepts offset-x, offset-y, blur-radius, and color.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'text-shadow: 2px 2px 4px rgba(0,0,0,0.5)',m:'text-shadow',
