...
export const sizing: CSSProperty[] = [
  {n:'width / height',c:'Sizing',d:'Sets element dimensions. Supports fixed lengths, percentages, and intrinsic size keywords.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'width: auto | 100% | 300px | min-content | max-content | fit-content',m:'width',
  ...
  {n:'aspect-ratio',c:'Sizing',d:'Sets a preferred aspect ratio so the element automatically scales proportionally.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'aspect-ratio: auto | 16/9 | 1 | 4/3',m:'aspect-ratio',
  ...
  {n:'min / max sizing',c:'Sizing',d:'min-width, max-width, min-height, max-height put hard constraints on element dimensions.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'max-width: 65ch;\nmin-height: 100svh;\nmax-inline-size: 80rem',m:'max-width',
  ...
  {n:'box-sizing',c:'Sizing',d:'Controls whether padding and border are included in the element\'s stated width and height.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'box-sizing: content-box | border-box',m:'box-sizing',
  ...
  {n:'inline-size',c:'Sizing',d:'Logical equivalent of width — adapts to writing direction. In vertical writing modes, this becomes height.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'inline-size: 100% | 300px | auto',m:'inline-size',
  ...
  {n:'block-size',c:'Sizing',d:'Logical equivalent of height — adapts to writing direction. In vertical writing modes, this becomes width.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'block-size: auto | 200px | 100%',m:'block-size',
  ...
  {n:'min-inline-size',c:'Sizing',d:'Logical equivalent of min-width — adapts to writing direction.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'min-inline-size: 0 | 200px | 100%',m:'min-inline-size',
  ...
  {n:'min-block-size',c:'Sizing',d:'Logical equivalent of min-height — adapts to writing direction.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'min-block-size: auto | 100px | 100%',m:'min-block-size',
  ...
  {n:'max-inline-size',c:'Sizing',d:'Logical equivalent of max-width — adapts to writing direction.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'max-inline-size: 80ch | none | 100%',m:'max-inline-size',
  ...
  {n:'max-block-size',c:'Sizing',d:'Logical equivalent of max-height — adapts to writing direction.',s:{ch:1,ff:1,sf:1,ed:1},i:'wide',x:'max-block-size: 100svh | none',m:'max-block-size',
