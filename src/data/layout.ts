    ...
    v: [
      {
        ...
        label: "Block",
        description:
          "Elements take full width available. Stack vertically one after another. Default for <div>, <p>, <h1>.",
      },
      {
        value: "inline",
        label: "Inline",
        description:
          "Elements flow within text. Only take as much width as their content. Cannot have width/height. Default for <span>, <a>.",
      },
      {
        value: "inline-block",
        label: "Inline Block",
        description:
          "Flows like inline but can have width/height. Great for nav items that need sizing but flow in text.",
      },
      {
        value: "flex",
        label: "Flex",
        description:
          "Creates a flex container. Enables flexible layouts with align-items, justify-content. Children become flex items.",
      },
      {
        value: "grid",
        label: "Grid",
        description:
          "Creates a grid container. Enables two-dimensional layouts with rows and columns. Children become grid items.",
      },
      {
        value: "none",
        label: "None",
        description:
          "Element is completely removed from the layout. Not rendered at all. Takes no space.",
      },
      {
        value: "contents",
        label: "Contents",
        description:
          "The element itself is skipped. Its children become direct children of the parent. Useful for flattening structure.",
      },
      {
        value: "flow-root",
        label: "Flow Root",
        description:
          "Creates a new block formatting context. Like a mini-root that contains floats. Useful for clearing floats.",
      },
    ],
  },
    ...
    v: [
      {
        ...
        label: "Static",
        description:
          "Default position. Element follows normal document flow. top, bottom, left, right, z-index have no effect.",
      },
      {
        value: "relative",
        label: "Relative",
        description:
          "Element stays in normal flow but can be offset with top, right, bottom, left. Creates a positioning context for children.",
      },
      {
        value: "absolute",
        label: "Absolute",
        description:
          "Element is removed from normal flow. Positions relative to nearest positioned ancestor. No space reserved for it.",
      },
      {
        value: "fixed",
        label: "Fixed",
        description:
          "Element is removed from normal flow. Positions relative to the viewport. Stays in place when scrolling.",
      },
      {
        value: "sticky",
        label: "Sticky",
        description:
          "Hybrid between relative and fixed. Acts relative until it hits a threshold, then fixed. Great for sticky headers.",
      },
    ],
  },
    ...
    v: [
      {
        ...
        label: "Auto",
        description:
          "Stack order determined by DOM order. Elements later in HTML appear on top. Default value.",
      },
      {
        value: "number",
        label: "Number (e.g., 1, 10, 100)",
        description:
          "Higher values appear on top. Works only on positioned elements (not static). Can use negative values.",
      },
      {
        value: "negative",
        label: "Negative (e.g., -1)",
        description:
          "Elements appear behind their parent's content. Useful for layering backgrounds behind elements.",
      },
    ],
  },
    ...
    v: [
      {
        ...
        label: "Visible",
        description:
          "Content that overflows is visible outside the box. May overlap other elements. Default behavior.",
      },
      {
        value: "hidden",
        label: "Hidden",
        description:
          "Overflowing content is clipped and hidden. No scrollbar appears. Content is inaccessible.",
      },
      {
        value: "scroll",
        label: "Scroll",
        description:
          "Content can be scrolled. Scrollbars appear even if there's no overflow. Provides consistent layout.",
      },
      {
        value: "auto",
        label: "Auto",
        description:
          "Scrollbars appear only when needed. Best for most cases. Content is accessible when it overflows.",
      },
      {
        value: "clip",
        label: "Clip",
        description:
          "Like hidden but removes entire element from tree. No accessibility tree. Content completely inaccessible.",
      },
    ],
  },
