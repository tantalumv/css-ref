...
export const CATEGORIES: Record<string, CategoryMeta> = {
  ...
  Grid: {
    ...
    color: "#ec4899",
    intro:
      "CSS Grid Layout is a powerful two-dimensional layout system that revolutionizes how we build web interfaces. Unlike Flexbox which works along a single axis, Grid lets you define both rows and columns simultaneously, making it perfect for page-level layouts and complex component designs. It treats the layout as a whole rather than individual items.",
    concepts: [
  ...
  Typography: {
    ...
    color: "#14b8a6",
    intro:
      "Typography in CSS encompasses everything about how text is displayed — from font selection and sizing to line height and text decoration. Good typography is crucial for readability, accessibility, and visual hierarchy. CSS provides extensive control over every aspect of text rendering.",
    concepts: [
  ...
  Color: {
    ...
    color: "#f59e0b",
    intro:
      "Color properties determine the visual appearance of elements through their foreground (text) and background colors. CSS supports multiple color formats including hex codes, RGB, HSL, and named colors. Understanding color is fundamental to creating visually appealing and accessible designs.",
    concepts: [
  ...
  Sizing: {
    ...
    color: "#06b6d4",
    intro:
      "Sizing properties define how big or small elements appear on the page. This includes fixed sizes, responsive percentages, and viewport-relative units. Proper sizing is essential for creating layouts that work across different screen sizes and maintain consistent proportions.",
    concepts: [
  ...
  Visual: {
    ...
    color: "#84cc16",
    intro:
      "Visual properties give elements their distinctive appearance through borders, backgrounds, shadows, and effects. These properties transform plain HTML elements into polished UI components. They are essential for creating depth, hierarchy, and visual interest in your designs.",
    concepts: [
  ...
  Animation: {
    ...
    color: "#f43f5e",
    intro:
      "Animation properties bring interfaces to life through motion and transitions. CSS animations can range from simple hover effects to complex multi-step sequences. They enhance user experience by providing visual feedback, guiding attention, and making interactions feel polished.",
    concepts: [
  ...
  Transform: {
    ...
    color: "#10b981",
    intro:
      "Transform properties modify an element's appearance by rotating, scaling, skewing, or moving it without affecting document flow. Transforms are hardware-accelerated in most browsers, making them performant for animations. They work in both 2D and 3D space.",
    concepts: [
  ...
  Spacing: {
    ...
    color: "#f97316",
    intro:
      "Spacing properties manage the distance between elements and their content. Proper spacing improves readability, creates visual hierarchy, and establishes consistent rhythm throughout a design. CSS offers multiple ways to control spacing, each with specific use cases.",
    concepts: [
  ...
  Interactivity: {
    ...
    color: "#0ea5e9",
    intro:
      "Interactivity properties control how users interact with elements through the cursor, text selection, scrolling behavior, and focus states. These properties enhance usability and provide visual feedback that guides users through your interface.",
    concepts: [
  ...
  "CSS Variables": {
    ...
    color: "#a855f7",
    intro:
      "CSS Variables (officially called custom properties) allow you to define reusable values that can be used throughout your stylesheet. They enable dynamic theming, easier maintenance, and more powerful design systems by centralizing values that might change across your design.",
    concepts: [
  ...
  Queries: {
    ...
    color: "#e11d48",
    intro:
      "Query properties enable responsive and adaptive design by applying styles based on device characteristics, viewport size, or container dimensions. They are essential for building designs that work across the vast range of devices and screen sizes.",
    concepts: [
  ...
  Selectors: {
    ...
    color: "#7c3aed",
    intro:
      "Selectors are the foundation of CSS — they define which elements your styles apply to. CSS offers an incredibly powerful selector system ranging from simple element names to complex patterns that can target elements based on attributes, states, position, and more.",
    concepts: [
  ...
  "UI Components": {
    ...
    color: "#0891b2",
    intro:
      "UI Component properties style the interactive elements that users interact with — forms, buttons, inputs, and other interface controls. These properties define how user interface elements appear and behave, creating the bridge between functional forms and visually appealing interfaces.",
    concepts: [
  ...
  Tables: {
    ...
    color: "#65a30d",
    intro:
      "Table properties control the layout and appearance of tabular data. While tables use HTML structure, CSS properties determine how the data is presented — from border styles and cell padding to entire table layout algorithms that affect how columns size themselves.",
    concepts: [
  ...
  Lists: {
    ...
    color: "#d97706",
    intro:
      "List properties control the presentation of list items — ordered and unordered lists, their markers, and positioning. CSS provides extensive control over how list markers appear, from traditional bullets and numbers to completely custom images.",
    concepts: [
  ...
  Misc: {
    ...
    color: "#6b7280",
    intro:
      "Miscellaneous properties cover useful CSS features that don't belong in other categories. This includes properties for content generation, quotes, text direction, and other specialized behaviors that enhance your designs in specific ways.",
    concepts: [
  ...
  Breaks: {
    ...
    color: "#db2777",
    intro:
      "Break properties control how content flows across pages in paged media, columns in multi-column layouts, and regions in CSS regions. They determine where content should be split and how it should behave at those break points.",
    concepts: [
