...
export const cssVariables: CSSProperty[] = [
  {
    n: "Custom Properties",
    c: "CSS Variables",
    d: "User-defined CSS variables (--my-var: value) reusable anywhere via var(). The foundation of design token systems.",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    x: "--brand: #6366f1;\n--space: clamp(1rem, 2vw, 2rem);\ncolor: var(--brand, black);",
    m: "Using_CSS_custom_properties",
...

  {
    n: "var()",
    c: "CSS Variables",
    d: "Reads a custom property value and optionally provides a fallback when the variable is missing.",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    x: "color: var(--brand, #111)",
    m: "var",
...

  {
    n: "@property",
    c: "CSS Variables",
    d: "Registers a custom property with a type, initial value, and inheritance — enables animation of custom properties.",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "b2024",
    x: '@property --angle {\n  syntax: "<angle>";\n  inherits: false;\n  initial-value: 0deg;\n}',
    m: "@property",
...

  {
    n: "env()",
    c: "CSS Variables",
    d: "Inserts a user-agent environment variable such as safe-area-inset for notched devices.",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
