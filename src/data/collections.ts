...
.item {
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px; flex-wrap: wrap;">
    <button data-on:click="$justifycontent = 'flex-start'; console.log('justifycontent:', $justifycontent)" data-class:active="$justifycontent === 'flex-start'" style="padding: 6px 12px; background: #4f46e5; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">flex-start</button>
    <button data-on:click="$justifycontent = 'center'; console.log('justifycontent:', $justifycontent)" data-class:active="$justifycontent === 'center'" style="padding: 6px 12px; background: #4f46e5; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">center</button>
    <button data-on:click="$justifycontent = 'space-between'; console.log('justifycontent:', $justifycontent)" data-class:active="$justifycontent === 'space-between'" style="padding: 6px 12px; background: #4f46e5; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">space-between</button>
    <button data-on:click="$justifycontent = 'space-around'; console.log('justifycontent:', $justifycontent)" data-class:active="$justifycontent === 'space-around'" style="padding: 6px 12px; background: #4f46e5; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">space-around</button>
    <button data-on:click="$alignitems = 'flex-start'; console.log('alignitems:', $alignitems)" data-class:active="$alignitems === 'flex-start'" style="padding: 6px 12px; background: #7c3aed; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">align-start</button>
    <button data-on:click="$alignitems = 'center'; console.log('alignitems:', $alignitems)" data-class:active="$alignitems === 'center'" style="padding: 6px 12px; background: #7c3aed; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">align-center</button>
    <button data-on:click="$flexwrap = 'wrap'; console.log('flexwrap:', $flexwrap)" data-class:active="$flexwrap === 'wrap'" style="padding: 6px 12px; background: #9333ea; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">wrap</button>
    <button data-on:click="$flexwrap = 'nowrap'; console.log('flexwrap:', $flexwrap)" data-class:active="$flexwrap === 'nowrap'" style="padding: 6px 12px; background: #9333ea; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">nowrap</button>
  </div>
  <div id="flexDemo" style="display: flex; height: 140px; background: rgba(255,255,255,0.1); border-radius: 8px; border: 2px dashed #6366f1;" data-style:justify-content="(console.log('justify-content:', $justifycontent), $justifycontent)" data-style:align-items="(console.log('align-items:', $alignitems), $alignitems)" data-style:flex-wrap="(console.log('flex-wrap:', $flexwrap), $flexwrap)">
...
.card-large { grid-column: span 2; grid-row: span 2; }`,
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px;">
    <button data-on:click="$_layoutType = 'classic'; console.log('_layoutType:', $_layoutType)" data-class:active="$_layoutType === 'classic'" style="padding: 6px 12px; background: #ec4899; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Classic</button>
    <button data-on:click="$_layoutType = 'hero'; console.log('_layoutType:', $_layoutType)" data-class:active="$_layoutType === 'hero'" style="padding: 6px 12px; background: #db2777; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Hero Focus</button>
    <button data-on:click="$_layoutType = 'dashboard'; console.log('_layoutType:', $_layoutType)" data-class:active="$_layoutType === 'dashboard'" style="padding: 6px 12px; background: #be185d; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Dashboard</button>
  </div>
  <div class="grid-demo" data-class:layout-class="(console.log('layout-class:', $_layoutType), $_layoutType)">
...
h1, h2, h3 {
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px; flex-wrap: wrap;">
    <button data-on:click="$fontsize = '16px'; console.log('fontsize:', $fontsize)" data-class:active="$fontsize === '16px'" style="padding: 6px 10px; background: #0d9488; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Small</button>
    <button data-on:click="$fontsize = '24px'; console.log('fontsize:', $fontsize)" data-class:active="$fontsize === '24px'" style="padding: 6px 10px; background: #0d9488; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Medium</button>
    <button data-on:click="$fontsize = '36px'; console.log('fontsize:', $fontsize)" data-class:active="$fontsize === '36px'" style="padding: 6px 10px; background: #0d9488; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Large</button>
    <button data-on:click="$lineheight = '1.2'; console.log('lineheight:', $lineheight)" data-class:active="$lineheight === '1.2'" style="padding: 6px 10px; background: #14b8a6; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Tight</button>
    <button data-on:click="$lineheight = '1.8'; console.log('lineheight:', $lineheight)" data-class:active="$lineheight === '1.8'" style="padding: 6px 10px; background: #14b8a6; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Loose</button>
    <button data-on:click="$letterspacing = '0px'; console.log('letterspacing:', $letterspacing)" data-class:active="$letterspacing === '0px'" style="padding: 6px 10px; background: #2dd4bf; color: #134e4a; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Normal</button>
    <button data-on:click="$letterspacing = '4px'; console.log('letterspacing:', $letterspacing)" data-class:active="$letterspacing === '4px'" style="padding: 6px 10px; background: #2dd4bf; color: #134e4a; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Wide</button>
  </div>
  <div contenteditable="true" id="textSample" style="background: rgba(255,255,255,0.95); padding: 20px; border-radius: 8px; color: #134e4a; outline: none; min-height: 80px; font-family: Georgia, serif;" data-style:font-size="(console.log('font-size:', $fontsize), $fontsize)" data-style:line-height="(console.log('line-height:', $lineheight), $lineheight)" data-style:letter-spacing="(console.log('letter-spacing:', $letterspacing), $letterspacing)">
...
.item {
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px; flex-wrap: wrap;">
    <button data-on:click="$_animKey = $_animKey + 1; console.log('_animKey:', $_animKey); setTimeout(() => { const el = document.getElementById('animBox'); console.log('Applying bounce animation'); el.style.animation = 'bounce 0.6s ease'; }, 10)" style="padding: 6px 12px; background: #fb7185; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Bounce</button>
    <button data-on:click="$_animKey = $_animKey + 1; console.log('_animKey:', $_animKey); setTimeout(() => { const el = document.getElementById('animBox'); console.log('Applying pulse animation'); el.style.animation = 'pulse 0.8s ease'; }, 10)" style="padding: 6px 12px; background: #f43f5e; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Pulse</button>
    <button data-on:click="$_animKey = $_animKey + 1; console.log('_animKey:', $_animKey); setTimeout(() => { const el = document.getElementById('animBox'); console.log('Applying shake animation'); el.style.animation = 'shake 0.5s ease'; }, 10)" style="padding: 6px 12px; background: #e11d48; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Shake</button>
    <button data-on:click="$_animKey = $_animKey + 1; console.log('_animKey:', $_animKey); setTimeout(() => { const el = document.getElementById('animBox'); console.log('Applying spin animation'); el.style.animation = 'spin 1s linear'; }, 10)" style="padding: 6px 12px; background: #be123c; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Spin</button>
  </div>
  <style>
...
.info { color: #3b82f6; background: #dbeafe; }`,
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px; flex-wrap: wrap; align-items: center;">
    ...
    <button data-on:click="$themebg = '#ffffff'; $themetext = '#1f2937'; $themeborder = '#d1d5db'; console.log('reset theme')" style="padding: 6px 12px; background: #92400e; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Reset</button>
  </div>
  <div id="themeCard" style="padding: 24px; border-radius: 12px; border: 2px solid; transition: all 0.3s ease;" data-style:background="(console.log('background:', $themebg), $themebg)" data-style:color="(console.log('color:', $themetext), $themetext)" data-style:border-color="(console.log('border-color:', $themeborder), $themeborder)">
...
.modal { position: fixed; z-index: 1000; }`,
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px;">
    <button data-on:click="$heroindex = 0; console.log('heroindex:', $heroindex)" data-class:active="$heroindex === 0" style="padding: 6px 12px; background: #16a34a; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Gradient</button>
    <button data-on:click="$heroindex = 1; console.log('heroindex:', $heroindex)" data-class:active="$heroindex === 1" style="padding: 6px 12px; background: #15803d; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Solid</button>
    <button data-on:click="$heroindex = 2; console.log('heroindex:', $heroindex)" data-class:active="$heroindex === 2" style="padding: 6px 12px; background: #166534; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Image</button>
    <button data-on:click="$heroindex = 3; console.log('heroindex:', $heroindex)" data-class:active="$heroindex === 3" style="padding: 6px 12px; background: #14532d; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 12px;">Pattern</button>
  </div>
  <div data-on:click="$heroindex = ($heroindex + 1) % 4" style="height: 140px; border-radius: 8px; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px; text-align: center; transition: all 0.5s ease; cursor: pointer;" data-style:background="(console.log('background:', $heroindex === 0 ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : $heroindex === 1 ? '#1e3a5f' : $heroindex === 2 ? 'linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.6)), url(https://picsum.photos/400/200?random=1)' : 'repeating-linear-gradient(45deg, #22c55e 0px, #22c55e 10px, #16a34a 10px, #16a34a 20px)'), $heroindex === 0 ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : $heroindex === 1 ? '#1e3a5f' : $heroindex === 2 ? 'linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(0,0,0,0.6)), url(https://picsum.photos/400/200?random=1)' : 'repeating-linear-gradient(45deg, #22c55e 0px, #22c55e 10px, #16a34a 10px, #16a34a 20px)')">
...
.article {
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px; flex-wrap: wrap;">
    <button data-on:click="$boxmargin = '0px'; console.log('boxmargin:', $boxmargin)" data-class:active="$boxmargin === '0px'" style="padding: 5px 10px; background: #c2410c; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">0px</button>
    <button data-on:click="$boxmargin = '20px'; console.log('boxmargin:', $boxmargin)" data-class:active="$boxmargin === '20px'" style="padding: 5px 10px; background: #c2410c; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">20px</button>
    <button data-on:click="$boxmargin = '40px'; console.log('boxmargin:', $boxmargin)" data-class:active="$boxmargin === '40px'" style="padding: 5px 10px; background: #c2410c; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">40px</button>
    <button data-on:click="$boxpadding = '10px'; console.log('boxpadding:', $boxpadding)" data-class:active="$boxpadding === '10px'" style="padding: 5px 10px; background: #ea580c; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">10px</button>
    <button data-on:click="$boxpadding = '30px'; console.log('boxpadding:', $boxpadding)" data-class:active="$boxpadding === '30px'" style="padding: 5px 10px; background: #ea580c; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">30px</button>
    <button data-on:click="$boxpadding = '50px'; console.log('boxpadding:', $boxpadding)" data-class:active="$boxpadding === '50px'" style="padding: 5px 10px; background: #ea580c; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">50px</button>
    <button data-on:click="$boxborder = '0px'; console.log('boxborder:', $boxborder)" data-class:active="$boxborder === '0px'" style="padding: 5px 10px; background: #f97316; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">0px</button>
    <button data-on:click="$boxborder = '8px'; console.log('boxborder:', $boxborder)" data-class:active="$boxborder === '8px'" style="padding: 5px 10px; background: #f97316; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">8px</button>
    <button data-on:click="$boxborder = '16px'; console.log('boxborder:', $boxborder)" data-class:active="$boxborder === '16px'" style="padding: 5px 10px; background: #f97316; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 11px;">16px</button>
  </div>
  <div style="display: flex; justify-content: center; align-items: center; height: 140px; background: rgba(255,255,255,0.1); border-radius: 8px; position: relative;">
    ...
    <div style="background: rgba(252, 211, 77, 0.3); padding: 20px; border-radius: 4px; transition: all 0.3s ease;" data-style:padding="(console.log('margin padding:', $boxmargin), $boxmargin)">
      <div style="position: absolute; top: 50px; left: 8px; color: rgba(255,255,255,0.5); font-size: 10px;">border</div>
      <div style="background: rgba(251, 146, 60, 0.5); padding: 8px; border-radius: 4px; transition: all 0.3s ease;" data-style:padding="(console.log('border padding:', $boxborder), $boxborder)">
        <div style="position: absolute; top: 90px; left: 8px; color: rgba(255,255,255,0.5); font-size: 10px;">padding</div>
        <div style="background: white; padding: 30px; border-radius: 4px; color: #7c2d12; font-weight: 600; font-size: 14px; text-align: center; transition: all 0.3s ease;" data-style:padding="(console.log('content padding:', $boxpadding), $boxpadding)">
          Content
        </div>
      </div>
    </div>
...
.smooth:hover { transform: translateX(50px); transition-timing-function: ease-in-out; }`,
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 16px;">
    <button data-on:click="$timing = 'ease'; console.log('timing:', $timing)" data-class:active="$timing === 'ease'" style="padding: 6px 10px; background: #7c3aed; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Ease</button>
    <button data-on:click="$timing = 'linear'; console.log('timing:', $timing)" data-class:active="$timing === 'linear'" style="padding: 6px 10px; background: #6d28d9; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Linear</button>
    <button data-on:click="$timing = 'ease-in'; console.log('timing:', $timing)" data-class:active="$timing === 'ease-in'" style="padding: 6px 10px; background: #5b21b6; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Ease-in</button>
    <button data-on:click="$timing = 'ease-out'; console.log('timing:', $timing)" data-class:active="$timing === 'ease-out'" style="padding: 6px 10px; background: #4c1d95; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Ease-out</button>
    <button data-on:click="$timing = 'ease-in-out'; console.log('timing:', $timing)" data-class:active="$timing === 'ease-in-out'" style="padding: 6px 10px; background: #3b0764; color: white; border: none; border-radius: 6px; cursor: pointer; font-size: 11px;">Ease-in-out</button>
  </div>
  <div style="display: flex; justify-content: center; gap: 16px; flex-wrap: wrap; height: 140px; background: rgba(255,255,255,0.1); border-radius: 8px; padding: 20px; align-items: center;">
    <div data-on:mouseenter="$_hover1 = true" data-on:mouseleave="$_hover1 = false" data-style:transform="(console.log('hover1 transform:', $_hover1 ? 'scale(1.1) rotate(5deg)' : 'scale(1) rotate(0deg)'), $_hover1 ? 'scale(1.1) rotate(5deg)' : 'scale(1) rotate(0deg)')" data-style:background="(console.log('hover1 background:', $_hover1 ? '#7c3aed' : '#c084fc'), $_hover1 ? '#7c3aed' : '#c084fc')" data-style:transition="(console.log('transition:', $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing), $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing)" style="padding: 12px 20px; background: #c084fc; color: white; border-radius: 8px; cursor: pointer; font-size: 12px; font-weight: 500; border: none;">Hover Me</div>
    <div data-on:mouseenter="$_hover2 = true" data-on:mouseleave="$_hover2 = false" data-style:transform="(console.log('hover2 transform:', $_hover2 ? 'scale(1.2)' : 'scale(1)'), $_hover2 ? 'scale(1.2)' : 'scale(1)')" data-style:transition="(console.log('transition:', $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing), $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing)" style="width: 50px; height: 50px; background: #a855f7; border-radius: 12px; cursor: pointer;"></div>
    <div data-on:click="$_clicked = !$_clicked" data-style:transform="(console.log('clicked transform:', $_clicked ? 'scale(0.95)' : 'scale(1)'), $_clicked ? 'scale(0.95)' : 'scale(1)')" data-style:background="(console.log('clicked background:', $_clicked ? '#ec4899' : '#9333ea'), $_clicked ? '#ec4899' : '#9333ea')" data-style:transition="(console.log('transition:', $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing), $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing)" style="padding: 10px 16px; background: #9333ea; color: white; border-radius: 6px; cursor: pointer; font-size: 12px;">Click Toggle</div>
    <input type="text" placeholder="Focus me" data-on:focus="$_focused = true" data-on:blur="$_focused = false" data-style:border-color="(console.log('focused border-color:', $_focused ? '#a855f7' : 'transparent'), $_focused ? '#a855f7' : 'transparent')" data-style:width="(console.log('focused width:', $_focused ? '140px' : '100px'), $_focused ? '140px' : '100px')" data-style:transition="(console.log('transition:', $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing), $timing === 'ease' ? 'all 0.5s ease' : 'all 0.5s ' + $timing)" style="padding: 10px 14px; border-radius: 6px; border: 2px solid transparent; outline: none; font-size: 12px; width: 100px;">
  </div>
</div>`,
    learningObjectives: [
