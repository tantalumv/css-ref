    ...
    v: [
      {
        ...
        description:
          "CSS supports 140+ named colors like 'red', 'blue', 'coral', 'teal'. Easy to remember but limited palette.",
      },
      {
        value: "hex",
        label: "Hexadecimal (#RRGGBB)",
        description:
          "Six-digit hex codes like #FF5733. #000 is black, #FFF is white. Most common for precise colors.",
      },
      {
        value: "rgb()",
        label: "RGB (rgb(r, g, b))",
        description:
          "Three values from 0-255 for red, green, blue. rgb(255, 0, 0) is pure red. Supports alpha via rgba().",
      },
      {
        value: "hsl()",
        label: "HSL (hsl(h, s%, l%))",
        description:
          "Hue (0-360), Saturation (0-100%), Lightness (0-100%). Easier to adjust colors programmatically.",
      },
      {
        value: "oklch()",
        label: "OKLCH (perceptually uniform)",
        description:
          "Modern color space with consistent perceived brightness. Supports wide gamuts for vivid colors. The future of CSS colors.",
      },
      {
        value: "transparent",
        label: "Transparent",
      ...
      },
      {
        ...
        label: "CurrentColor",
        description:
          "Inherits the color from the element's color property. Useful for icons and borders that should match text.",
      },
    ],
  },
    ...
    v: [
      {
        ...
        description:
          "background: red or background: #FF5733. The simplest form—just sets a solid color.",
      },
      {
        value: "image",
        label: "Background Image",
        description:
          "background: url(image.png) or background: linear-gradient(). Adds an image or gradient as background.",
      },
      {
        value: "repeat",
        label: "Repeat Pattern",
        description:
          "background: repeat-x, repeat-y, or no-repeat. Controls how the image tiles across the element.",
      },
      {
        value: "position",
        label: "Position",
        description:
          "background: center, top left, 50% 25%. Positions the image within the element.",
      },
      {
        value: "size",
        label: "Size",
        description:
          "background: cover or contain, or specific sizes like 100px 200px. Controls image dimensions.",
      },
      {
        value: "shorthand",
        label: "Full Shorthand",
        description:
          "background: url(img.jpg) no-repeat center / cover. Position and size are separated by a slash.",
      },
    ],
  },
...

  {
    ...
    v: [
      ...
      },
      {
        ...
        label: "Light",
        description:
          "Forces light mode rendering. Form controls and scrollbars use light colors theme.",
      },
      {
        value: "dark",
        label: "Dark",
        description:
          "Forces dark mode rendering. Form controls and scrollbars use dark theme colors.",
      },
      {
        value: "light dark",
        label: "Light Dark",
        description:
          "Allows both light and dark depending on user preference. Browser will automatically adapt.",
      },
    ],
  },
