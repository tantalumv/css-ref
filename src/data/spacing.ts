...
export const spacing: CSSProperty[] = [
  {
    n: "margin",
    c: "Spacing",
    d: "Sets outer spacing on all four sides. Use margin-top/right/bottom/left for individual sides, or margin-inline/margin-block for logical directions.",
    ...
    v: [
      ...
      },
      {
        ...
        description:
          "Adds a specific amount of space. em is relative to the element's font-size, rem is relative to root font-size.",
      },
      {
        value: "%",
        label: "Percentage (e.g., 10%)",
        description:
          "Percentage is calculated based on the width of the containing block. Useful for responsive spacing.",
      },
      {
        value: "auto",
        label: "Auto",
        description:
          "Browser calculates the margin. With horizontal centering, use margin: 0 auto to center a sized element.",
      },
      {
        value: "negative",
        label: "Negative (e.g., -10px)",
        description:
          "Negative margins pull the element closer to adjacent elements. Can cause overlapping.",
      },
      {
        value: "shorthand-1",
      ...
      },
      {
        ...
        description:
          "First value is top/bottom, second is right/left. Think of it as pairs: vertical, horizontal.",
      },
      {
        value: "shorthand-3",
        label: "Three Values",
      ...
      },
      {
        ...
        label: "Four Values",
        description:
          "Top, right, bottom, left. Goes clockwise starting from top. Remember: TRouBLe mnemonic.",
      },
    ],
  },

  {
    n: "padding",
    c: "Spacing",
    d: "Sets inner spacing on all four sides. Use padding-top/right/bottom/left for individual sides, or padding-inline/padding-block for logical directions.",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    ...
    v: [
      ...
      },
      {
        ...
        label: "Percentage (e.g., 10%)",
        description:
          "Percentage is calculated based on the width of the element itself (not parent). Great for aspect ratios.",
      },
      {
        value: "shorthand-1",
        label: "One Value",
...

  {
    n: "margin-inline",
    c: "Spacing",
    d: "Logical shorthand for margin-inline-start and margin-inline-end — adapts to writing direction (horizontal in LTR, vertical in vertical writing modes).",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    x: "margin-inline: auto | 1rem | 2rem 4rem",
    m: "margin-inline",
...

  {
    n: "padding-block",
    c: "Spacing",
    d: "Logical shorthand for padding-block-start and padding-block-end — adapts to writing direction (vertical in LTR, horizontal in vertical writing modes).",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    x: "padding-block: 1rem | 0.5rem 2rem",
    m: "padding-block",
...

  {
    n: "margin-block",
    c: "Spacing",
    d: "Logical shorthand for margin-block-start and margin-block-end — adapts to writing direction (vertical in LTR, horizontal in vertical writing modes).",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    x: "margin-block: auto | 1rem | 2rem 1rem",
    m: "margin-block",
...

  {
    n: "padding-inline",
    c: "Spacing",
    d: "Logical shorthand for padding-inline-start and padding-inline-end — adapts to writing direction (horizontal in LTR, vertical in vertical writing modes).",
    s: { ch: 1, ff: 1, sf: 1, ed: 1 },
    i: "wide",
    x: "padding-inline: 1rem | 0.5rem 2rem",
    m: "padding-inline",
